        ...
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-brand-primary hover:bg-brand-primary/90 text-white px-4 py-2 rounded-full font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
            >
              立即订购蛋糕
            </a>
          </div>
        ...
        <div className="relative z-10 text-center px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-brand-primary hover:bg-brand-primary/90 text-white px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
              立即订购蛋糕
            </a>
          </div>
